...
public class Flow implements org.apache.thrift.TBase<Flow, Flow._Fields>, java.io.Serializable, Cloneable, Comparable<Flow> {
  ...
  private static final org.apache.thrift.protocol.TField VARIANT_FIELD_DESC = new org.apache.thrift.protocol.TField("variant", org.apache.thrift.protocol.TType.STRING, (short)4);
  private static final org.apache.thrift.protocol.TField VARIANT_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("variantName", org.apache.thrift.protocol.TType.STRING, (short)5);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new FlowStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new FlowTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable java.lang.String id; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String idName; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String name; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String variant; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String variantName; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    NAME((short)3, "name"),
    VARIANT((short)4, "variant"),
    VARIANT_NAME((short)5, "variantName");
  ...
  static {
    ...
    tmpMap.put(_Fields.VARIANT, new org.apache.thrift.meta_data.FieldMetaData("variant", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.VARIANT_NAME, new org.apache.thrift.meta_data.FieldMetaData("variantName", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Flow setId(@org.apache.thrift.annotation.Nullable java.lang.String id) {
    this.id = id;
    return this;
  }
  ...
  public Flow setIdName(@org.apache.thrift.annotation.Nullable java.lang.String idName) {
    this.idName = idName;
    return this;
  }
  ...
  public Flow setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public Flow setVariant(@org.apache.thrift.annotation.Nullable java.lang.String variant) {
    this.variant = variant;
    return this;
  }
  ...
  public Flow setVariantName(@org.apache.thrift.annotation.Nullable java.lang.String variantName) {
    this.variantName = variantName;
    return this;
  }
  ...
  /** Returns true if field variantName is set (has been assigned a value) and false otherwise */
  public boolean isSetVariantName() {
    return this.variantName != null;
  }

  public void setVariantNameIsSet(boolean value) {
    if (!value) {
      this.variantName = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case VARIANT_NAME:
      if (value == null) {
        ...
        setVariantName((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(Flow that) {
    ...
    boolean this_present_variantName = true && this.isSetVariantName();
    boolean that_present_variantName = true && that.isSetVariantName();
    if (this_present_variantName || that_present_variantName) {
      if (!(this_present_variantName && that_present_variantName))
        return false;
      if (!this.variantName.equals(that.variantName))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetVariantName()) ? 131071 : 524287);
    if (isSetVariantName())
      hashCode = hashCode * 8191 + variantName.hashCode();
  ...
  public int compareTo(Flow other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIdName()).compareTo(other.isSetIdName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIdName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVariantName()).compareTo(other.isSetVariantName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVariantName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.variantName, other.variantName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Flow(");
    boolean first = true;
  ...
  private static class FlowStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FlowStandardScheme getScheme() {
      return new FlowStandardScheme();
    }
  }

  private static class FlowStandardScheme extends org.apache.thrift.scheme.StandardScheme<Flow> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Flow struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // VARIANT_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.variantName = iprot.readString();
              struct.setVariantNameIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Flow struct) throws org.apache.thrift.TException {
      ...
      if (struct.variantName != null) {
        oprot.writeFieldBegin(VARIANT_NAME_FIELD_DESC);
        oprot.writeString(struct.variantName);
        oprot.writeFieldEnd();
      }
  ...
  private static class FlowTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FlowTupleScheme getScheme() {
      return new FlowTupleScheme();
    }
  }

  private static class FlowTupleScheme extends org.apache.thrift.scheme.TupleScheme<Flow> {
